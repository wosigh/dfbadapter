...
//	 gtk_init(NULL, NULL);
	 ...
	 sprintf(dfb_pb->plugin_socket_name, "/tmp/dfbadapter-plugin");
	 sprintf(dfb_pb->dfb_socket_name, "/tmp/dfbadapter-dfb");
	 sprintf(dfb_pb->dfb_primarymem_name, "/dev/shm/dfbadapter.mem");
